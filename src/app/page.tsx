    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-5 py-5 animate-fade-in">
        <div className="bg-white rounded-xl shadow-md p-5 mb-4">
          ...
          <h3 className="text-[#1A2753] text-lg font-bold mt-4 mb-1">トイレ</h3>
          <p>5ゲートの再入場口を出て右手側の階段下にあります。</p>
          <h3 className="text-[#1A2753] text-lg font-bold mt-4 mb-1">休憩の取り方</h3>
          <p>5ゲートの再入場口から外に出て、グッズ売り場の前を通り控室に戻ってください。</p>
          <h3 className="text-[#1A2753] text-lg font-bold mt-4 mb-1">🚫禁止事項</h3>
